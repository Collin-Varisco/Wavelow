#############################################################################
# Makefile for building: slowdown
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = slowdown1.0.0
DISTDIR = /home/crisco/temp/SlowDown/.tmp/slowdown1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L/home/crisco/temp/SlowDown/libs/irrKlang-64bit-1.6.0/bin/linux-gcc-64/ -lIrrKlang /usr/lib64/libQt5Widgets.so /usr/lib64/libQt5Gui.so /usr/lib64/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		build.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = slowdown
DESTDIR       = 
TARGET        = slowdown
