...
DISTDIR = /home/crisco/test-wavelow/Wavelow/.tmp/wavelow1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) /usr/lib/ikpMP3.so /usr/lib/libIrrKlang.so /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
moc_wave.cpp: src/wave.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/crisco/test-wavelow/Wavelow/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/crisco/test-wavelow/Wavelow -I/home/crisco/test-wavelow/Wavelow/libs/irrKlang-64bit-1.6.0/include -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/11.1.0 -I/usr/include/c++/11.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/11.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/11.1.0/include-fixed -I/usr/include src/wave.h -o moc_wave.cpp
